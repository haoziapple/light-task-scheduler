...
create index IDX1_JOB_CLIENT_MONITOR on LTS_ADMIN_JOB_CLIENT_MONITOR_DATA (timestamp);
create index IDX2_JOB_CLIENT_MONITOR on LTS_ADMIN_JOB_CLIENT_MONITOR_DATA (identity);
create index IDX3_JOB_CLIENT_MONITOR on LTS_ADMIN_JOB_CLIENT_MONITOR_DATA (node_group);