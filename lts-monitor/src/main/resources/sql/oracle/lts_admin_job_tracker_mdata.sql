create table LTS_ADMIN_JOB_TRACKER_MDATA
(
...
create index IDX1_JOB_TRACKER_MONITOR on LTS_ADMIN_JOB_TRACKER_MDATA (timestamp);
create index IDX2_JOB_TRACKER_MONITOR on LTS_ADMIN_JOB_TRACKER_MDATA (identity);